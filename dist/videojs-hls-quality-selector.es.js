...
var HlsQualitySelectorPlugin = function () {
  ...
  HlsQualitySelectorPlugin.prototype.bindPlayerEvents = function bindPlayerEvents() {
    this.player.qualityLevels().on('addqualitylevel', this.onAddQualityLevel.bind(this, this.config.sortAscending, this.config.autoPlacement));
  };
  ...
  HlsQualitySelectorPlugin.prototype.onAddQualityLevel = function onAddQualityLevel() {
    ...
    var sortAscending = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    var autoPlacement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'bottom';
    ...
    var levelItems = [];
    var autoMenuItem = this.getQualityMenuItem.call(this, {
    ...
    if (this._qualityButton) {
      this._qualityButton.createItems = function () {
        ...
        return autoPlacement === 'top' ? [autoMenuItem].concat(levelItems) : [].concat(levelItems, [autoMenuItem]);
      };
